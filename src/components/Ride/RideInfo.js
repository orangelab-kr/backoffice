...
import { CouponInfoProvider, PaymentItem, RefundModal } from '..';
import {
  EditOutlined,
  PlusOutlined,
  SmileOutlined,
...
>${idx}</div>`;
  ...
  const onAddPayment = (paymentInfo) => {
    ...
    getClient('openapi-ride')
      .then((c) =>
        c.post(
          `/rides/${ride.properties.openapi.rideId}/payments`,
          paymentInfo,
        ),
      )
      .finally(() => setLoading(false))
                          ...
                          <Descriptions bordered size="small">
                            {terminateReceipt ? (
                              <>
                                ...
                                {terminateReceipt.surcharge.discount !== 0 && (
                                  <Descriptions.Item
                                    label="추가요금 할인 금액"
                                    span={3}
                                  >
                                ...
                                {terminateReceipt.total !== 0 && (
                                  <Descriptions.Item
                                    ...
                                    span={3}
                                  >
                                    {terminateReceipt.price.toLocaleString()}원
                                  </Descriptions.Item>
                                )}
                                ...
                                <Descriptions.Item label="최종 금액" span={3}>
                                  {terminateReceipt.total.toLocaleString()}원
                                </Descriptions.Item>
                              </>
                            ) : (
                              <Descriptions.Item>
                ...
                <Tabs defaultActiveKey="receipt" onChange={onReceiptChange}>
                  <Tabs.TabPane tab="영수증" key="receipt">
                    <Descriptions bordered size="small">
                      ...
                      <Descriptions.Item label="기본요금 결제 금액" span={1}>
                        {openapiRide.receipt.standard.price.toLocaleString()}원
                      </Descriptions.Item>
                      <Descriptions.Item label="기본요금 할인 금액" span={1}>
                        -
                        {openapiRide.receipt.standard.discount.toLocaleString()}
                        원
                      </Descriptions.Item>
                      <Descriptions.Item label="기본요금 최종 금액" span={1}>
                        {openapiRide.receipt.standard.total.toLocaleString()}원
                      </Descriptions.Item>

                      <Descriptions.Item label="분당요금 결제 금액" span={1}>
                        {openapiRide.receipt.perMinute.price.toLocaleString()}원
                      </Descriptions.Item>
                      <Descriptions.Item label="분당요금 할인 금액" span={1}>
                        -
                        {openapiRide.receipt.perMinute.discount.toLocaleString()}
                        원
                      </Descriptions.Item>
                      <Descriptions.Item label="분당요금 최종 금액" span={1}>
                        {openapiRide.receipt.perMinute.total.toLocaleString()}원
                      </Descriptions.Item>

                      <Descriptions.Item label="추가요금 결제 금액" span={1}>
                        {openapiRide.receipt.surcharge.price.toLocaleString()}원
                      </Descriptions.Item>
                      <Descriptions.Item label="추가요금 할인 금액" span={1}>
                        -
                        {openapiRide.receipt.surcharge.discount.toLocaleString()}
                        원
                      </Descriptions.Item>
                      <Descriptions.Item label="추가요금 최종 금액" span={1}>
                        {openapiRide.receipt.surcharge.total.toLocaleString()}원
                      </Descriptions.Item>
